...
public class animalImageAdapter extends RecyclerView.Adapter<animalImageAdapter.ImageViewHolder> {
    private Context mContext;
    private List<Education> mEdcation;

    public animalImageAdapter(Context context, List<Education> educations)
    {
        mContext=context;
...
final String imageUri = uploadCur.getImgUrl();
        ...
        imageViewHolder.image_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent newInent = new Intent(mContext,animalAfterRecy.class);
