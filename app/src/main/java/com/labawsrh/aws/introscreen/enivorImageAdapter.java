...
public class enivorImageAdapter extends RecyclerView.Adapter<enivorImageAdapter.ImageViewHolder> {
    private Context mContext;
    private List<Education> mEdcation;

    public enivorImageAdapter(Context context, List<Education> educations)
    {
        mContext=context;
...
final String imageUri = uploadCur.getImgUrl();
        ...
        imageViewHolder.image_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent newInent = new Intent(mContext,enivorAfterRecy.class);
