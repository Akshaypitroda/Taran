...
public class womanImageAdapter extends RecyclerView.Adapter<womanImageAdapter.ImageViewHolder> {
    private Context mContext;
    private List<Education> mEdcation;

    public womanImageAdapter(Context context, List<Education> educations)
    {
        mContext=context;
...
final String imageUri = uploadCur.getImgUrl();
        ...
        imageViewHolder.image_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent newInent = new Intent(mContext,womanAfterRecy.class);
